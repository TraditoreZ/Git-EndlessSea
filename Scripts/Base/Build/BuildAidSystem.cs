...
namespace Assets.Scripts.Base.Build
{
    ...
    public class BuildAidSystem : MonoSingleton<BuildAidSystem>
    {
        ...
        private void PartPosUp(Vector3 currtCube)
        {
            ...
            {
                // 加个判断  切换物品的时候更新一次
                if (lastPartDes != currtCube || lastItemType != BuildingManager.instance.currtItemType)
                {
                    ...
                    Debug.Log("currtDirection" + BuildingManager.instance.GetTargerCubeDirection());
        ...
        private bool CheckPartOnTerrain()
        {
            ...
            {
                if (BuildingManager.instance.cubeHit.collider != null && BuildingManager.instance.cubeHit.collider.tag == "Cube")  //---BUG
                    return true;
                return false;
            }
            return true;
